...
export async function middleware(request: NextRequest) {
    ...
    // (the page itself will be the one to show an error)
    ...
    try {
        ...
        // If something goes wrong with auth, just let the request through
        // rather than crashing the whole middleware
    }
